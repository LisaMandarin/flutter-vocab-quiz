...
List<VocabItem> verbList = [
  ...
  VocabItem(word: "eat", definition: "to put food in your mouth and swallow it"),
  ...
  VocabItem(word: "read", definition: "to look at and understand written words"),
  ...
  VocabItem(word: "walk", definition: "to move with your feet at a normal speed"),
];

List<VocabItem> nounList = [
  VocabItem(word: "dog", definition: "a common animal that barks and lives with people"),
  VocabItem(word: "cat", definition: "a small animal with fur that likes to sleep and play"),
  ...
  VocabItem(word: "apple", definition: "a round fruit that is red, green, or yellow"),
  VocabItem(word: "chair", definition: "a seat with legs and a back to sit on"),
  VocabItem(word: "table", definition: "a flat surface with legs used for eating or working"),
